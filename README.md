...
- Se modifican nombres de funciones para que quede más legible. (getStatement)
- En lugar de llamar en getStatement a la película y al título, se crea una función en rental que llame al título de la película.

## <em>**Versión 23**</em>

### <em>**Refactoring**</em>

- Se añade la clase MovieProperties. Devuelve un objeto con el charge y los frequentRenterPoints. 

## <em>**Versión 24**</em>

### <em>**Refactoring**</em>

- Se cambian los while por for en la clase Customer.
